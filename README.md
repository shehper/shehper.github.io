...
My research is inspired by the scaling of AI models and their capabilities in the recent years. See [my implementation](https://arxiv.org/abs/2001.08361) of [the first scaling laws paper]. My implementation indicates that the optimal scaling of the size of langauge models might be independent of the choice of training dataset (when keeping hyperparameters and the choice of tokenizer fixed). It is known that this scaling law depends on various hyperparameters, courtesy of the Chinchilla scaling law.
